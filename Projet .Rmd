...
# avec 0,9 on retrouve 585 variables 

# extraction dans data_g les colonnes correspondantes

data_g_0.9_cor <- data_g[,(colnames(data_g) %in% list_gene_core)]
```
...
# Construction de données à tester : Y = data_g_0.9_cor
```{r notre Y, données génétiques + les 10 mesures cliniques}
Y = data_g_0.9_cor
# et le scaler
Yscaled=scale(Y)
